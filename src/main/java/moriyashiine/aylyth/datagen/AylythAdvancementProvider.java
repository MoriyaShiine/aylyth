...
public class AylythAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(Consumer<Advancement> consumer) {
        var root = Advancement.Builder.create()
                .display(ModItems.YMPE_SAPLING.getDefaultStack(), Text.translatable("advancements.aylyth.aylyth.root.title"), Text.translatable("advancements.aylyth.aylyth.root.desc"), new Identifier(Aylyth.MOD_ID, "textures/block/ympe_planks.png"), AdvancementFrame.TASK, true, true, false)
        ...
        var inTheBranches = Advancement.Builder.create()
                .parent(root)
                .display(ModItems.YMPE_DAGGER, Text.translatable("advancements.aylyth.aylyth.in_the_branches.title"), Text.translatable("advancements.aylyth.aylyth.in_the_branches.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        var lifeAtACost = Advancement.Builder.create()
                ...
                .display(ModItems.YMPE_FRUIT, Text.translatable("advancements.aylyth.aylyth.life_at_a_cost.title"), Text.translatable("advancements.aylyth.aylyth.life_at_a_cost.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(lifeAtACost)
                .display(stackWithNbt(ModItems.SHUCKED_YMPE_FRUIT, nbtCompound -> nbtCompound.putInt("StoredEntity", 1)), Text.translatable("advancements.aylyth.aylyth.daemon_ritus.title"), Text.translatable("advancements.aylyth.aylyth.daemon_ritus.desc"), null, AdvancementFrame.GOAL, true, true, false)
                .criterion("has_shucked", ShuckingCriterion.Conditions.create())
                .build(consumer, "aylyth:aylyth/daemon_ritus");
        Advancement.Builder.create()
                .parent(lifeAtACost)
                .display(ModItems.CORIC_SEED, Text.translatable("advancements.aylyth.aylyth.manufactured_for_a_purpose.title"), Text.translatable("advancements.aylyth.aylyth.manufactured_for_a_purpose.desc"), null, AdvancementFrame.GOAL, true, true, false)
        ...
        var laccus = Advancement.Builder.create()
                .parent(root)
                .display(ModItems.NYSIAN_GRAPE_VINE, Text.translatable("advancements.aylyth.aylyth.laccus.title"), Text.translatable("advancements.aylyth.aylyth.laccus.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(laccus)
                .display(potionItem(ModPotions.MORTECHIS_POTION), Text.translatable("advancements.aylyth.aylyth.libations.title"), Text.translatable("advancements.aylyth.aylyth.libations.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(laccus)
                .display(ModItems.NYSIAN_GRAPES, Text.translatable("advancements.aylyth.aylyth.come_wayward_souls.title"), Text.translatable("advancements.aylyth.aylyth.come_wayward_souls.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        var dontLookBack = Advancement.Builder.create()
                .parent(root)
                .display(Items.SOUL_CAMPFIRE, Text.translatable("advancements.aylyth.aylyth.dont_look_back.title"), Text.translatable("advancements.aylyth.aylyth.dont_look_back.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(dontLookBack)
                .display(ModItems.AYLYTHIAN_HEART, Text.translatable("advancements.aylyth.aylyth.into_the_fire_we_fly.title"), Text.translatable("advancements.aylyth.aylyth.into_the_fire_we_fly.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(root)
                .display(ModItems.SOUL_HEARTH, Text.translatable("advancements.aylyth.aylyth.something_between_life_and_death.title"), Text.translatable("advancements.aylyth.aylyth.something_between_life_and_death.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        var meatFound = Advancement.Builder.create()
                .parent(root)
                .display(ModItems.WRONGMEAT, Text.translatable("advancements.aylyth.aylyth.meat_found.title"), Text.translatable("advancements.aylyth.aylyth.meat_found.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(meatFound)
                .display(ModItems.VITAL_THURIBLE, Text.translatable("advancements.aylyth.aylyth.flesh_increased_by_two.title"), Text.translatable("advancements.aylyth.aylyth.flesh_increased_by_two.desc"), null, AdvancementFrame.GOAL, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(root)
                .display(ModItems.WRITHEWOOD_DOOR, Text.translatable("advancements.aylyth.aylyth.way_of_the_wood.title"), Text.translatable("advancements.aylyth.aylyth.way_of_the_wood.desc"), null, AdvancementFrame.CHALLENGE, true, true, false)
                ...
                .criterion("has_visited_coniferous_deepwood", TickCriterion.Conditions.createLocation(LocationPredicate.biome(ModBiomeKeys.CONIFEROUS_DEEPWOOD)))
                .criterion("has_visited_clearing", TickCriterion.Conditions.createLocation(LocationPredicate.biome(ModBiomeKeys.CLEARING)))
                .criterion("has_visited_overgrown_clearing", TickCriterion.Conditions.createLocation(LocationPredicate.biome(ModBiomeKeys.OVERGROWN_CLEARING)))
                .criterion("has_visited_uplands", TickCriterion.Conditions.createLocation(LocationPredicate.biome(ModBiomeKeys.UPLANDS)))
                .criterion("has_visited_mire", TickCriterion.Conditions.createLocation(LocationPredicate.biome(ModBiomeKeys.MIRE)))
                .criterion("has_visited_bowels", TickCriterion.Conditions.createLocation(LocationPredicate.biome(ModBiomeKeys.BOWELS)))
                .build(consumer, "aylyth:aylyth/way_of_the_wood");
        Advancement.Builder.create()
                .parent(root)
                .display(ModItems.GIRASOL_SEED, Text.translatable("advancements.aylyth.aylyth.see_you_in_the_trees.title"), Text.translatable("advancements.aylyth.aylyth.see_you_in_the_trees.desc"), null, AdvancementFrame.GOAL, true, true, false)
