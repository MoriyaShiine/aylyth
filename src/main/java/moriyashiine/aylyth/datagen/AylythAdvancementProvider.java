...
public class AylythAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(Consumer<Advancement> consumer) {
        ...
        Advancement.Builder.create()
                .parent(root)
                .display(new CustomAdvancementDisplay(AylythUtil.id("textures/mob_effect/cimmerian.png"), Text.translatable("aylyth.advancements.aylyth.cimmerianed.title"), Text.translatable("aylyth.advancements.aylyth.cimmerianed.desc"), null, AdvancementFrame.TASK, true, true, false))
        ...
        Advancement.Builder.create()
                .parent(root)
                .display(new CustomAdvancementDisplay(AylythUtil.id("textures/mob_effect/wyrded.png"), Text.translatable("aylyth.advancements.aylyth.wyrded.title"), Text.translatable("aylyth.advancements.aylyth.wyrded.desc"), null, AdvancementFrame.TASK, true, true, false))
        ...
        var inTheBranches = Advancement.Builder.create()
                .parent(root)
                .display(ModItems.YMPE_DAGGER, Text.translatable("aylyth.advancements.aylyth.in_the_branches.title"), Text.translatable("aylyth.advancements.aylyth.in_the_branches.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        var lifeAtACost = Advancement.Builder.create()
                ...
                .display(ModItems.YMPE_FRUIT, Text.translatable("aylyth.advancements.aylyth.life_at_a_cost.title"), Text.translatable("aylyth.advancements.aylyth.life_at_a_cost.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(lifeAtACost)
                .display(stackWithNbt(ModItems.SHUCKED_YMPE_FRUIT, nbtCompound -> nbtCompound.putInt("StoredEntity", 1)), Text.translatable("aylyth.advancements.aylyth.daemon_ritus.title"), Text.translatable("aylyth.advancements.aylyth.daemon_ritus.desc"), null, AdvancementFrame.GOAL, true, true, false)
                .criterion("has_shucked", ShuckingCriterion.Conditions.create())
                .build(consumer, "aylyth:aylyth/daemon_ritus");
        Advancement.Builder.create()
                .parent(lifeAtACost)
                .display(ModItems.CORIC_SEED, Text.translatable("aylyth.advancements.aylyth.manufactured_for_a_purpose.title"), Text.translatable("aylyth.advancements.aylyth.manufactured_for_a_purpose.desc"), null, AdvancementFrame.GOAL, true, true, false)
        ...
        var laccus = Advancement.Builder.create()
                .parent(root)
                .display(ModItems.NYSIAN_GRAPE_VINE, Text.translatable("aylyth.advancements.aylyth.laccus.title"), Text.translatable("aylyth.advancements.aylyth.laccus.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(laccus)
                .display(potionItem(ModPotions.MORTECHIS_POTION), Text.translatable("aylyth.advancements.aylyth.libations.title"), Text.translatable("aylyth.advancements.aylyth.libations.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(laccus)
                .display(ModItems.NYSIAN_GRAPES, Text.translatable("aylyth.advancements.aylyth.come_wayward_souls.title"), Text.translatable("aylyth.advancements.aylyth.come_wayward_souls.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        Advancement.Builder.create()
                .parent(dontLookBack)
                .display(ModItems.AYLYTHIAN_HEART, Text.translatable("aylyth.advancements.aylyth.into_the_fire_we_fly.title"), Text.translatable("aylyth.advancements.aylyth.into_the_fire_we_fly.desc"), null, AdvancementFrame.TASK, true, true, false)
        ...
        var meatFound = Advancement.Builder.create()
                .parent(root)
                .display(ModItems.WRONGMEAT, Text.translatable("aylyth.advancements.aylyth.meat_found.title"), Text.translatable("aylyth.advancements.aylyth.meat_found.desc"), null, AdvancementFrame.TASK, true, true, false)
