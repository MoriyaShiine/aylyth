...
public class ModVegetationFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> WOODY_GROWTH_PATCH_PLACED = registerPlaced("woody_growth_patch", WOODY_GROWTH_PATCH, List.of(SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of(), PlacedFeatures.wouldSurvive(ModBlocks.YMPE_BLOCKS.sapling)));
