...
public class ModVegetationFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> WOODY_GROWTH_PATCH_PLACED = registerPlaced("woody_growth_patch", WOODY_GROWTH_PATCH, List.of(SquarePlacementModifier.of(), SurfaceWaterDepthFilterPlacementModifier.of(2), PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of()));
