...
public class GirasolFoliagePlacer extends FoliagePlacer {
    public static final MapCodec<GirasolFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> fillFoliagePlacerFields(instance).apply(instance, GirasolFoliagePlacer::new));
