...
public class SmallWoodyGrowthBlock extends Block implements Waterloggable {
    ...
    protected BlockState getStateForNeighborUpdate(BlockState state, WorldView world, ScheduledTickView tickView, BlockPos pos, Direction direction, BlockPos neighborPos, BlockState neighborState, Random random) {
        return direction.equals(Direction.DOWN) && !neighborState.isSideSolidFullSquare(world, neighborPos, Direction.UP) ? Blocks.AIR.getDefaultState() : super.getStateForNeighborUpdate(state, world, tickView, pos, direction, neighborPos, neighborState, random);
    }

    @Override
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        BlockState downState = world.getBlockState(pos.down());
        return downState.isFullCube(world, pos.down()) || downState.isIn(AylythBlockTags.WOODY_GROWTHS_GENERATE_ON);
    }
