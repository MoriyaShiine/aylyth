...
public class LargeWoodyGrowthBlock extends SmallWoodyGrowthBlock {
    ...
    protected BlockState getStateForNeighborUpdate(BlockState state, WorldView world, ScheduledTickView tickView, BlockPos pos, Direction direction, BlockPos neighborPos, BlockState neighborState, Random random) {
        ...
        return doubleBlockHalf == DoubleBlockHalf.LOWER ? super.getStateForNeighborUpdate(state, world, tickView, pos, direction, neighborPos, neighborState, random) : state;
    }
