...
public class ModBlocks {
	...
	public static final WoodSuite YMPE_SUITE = WoodSuite.of(new Identifier(Aylyth.MOD_ID, "ympe"),
			WoodSuite.CopySettingsSet.DEFAULT_SETTINGS_SET, WoodSuite.GroupedSettings.of(ModItems.GROUP), Registry.BLOCK, Registry.ITEM, MapColor.BROWN,
			BlockSoundGroup.GRASS, new LargeTreeSaplingGenerator() {
		@Nullable
		@Override
...
//		flammableRegistry.add(YMPE_FENCE_GATE, 5, 20);
		flammableRegistry.add(YMPE_SUITE.strippedLog, 5, 5);
		flammableRegistry.add(YMPE_SUITE.strippedWood, 5, 5);
		flammableRegistry.add(YMPE_SUITE.log, 5, 5);
		flammableRegistry.add(YMPE_SUITE.wood, 5, 5);
		flammableRegistry.add(YMPE_SUITE.leaves, 30, 60);
		flammableRegistry.add(YMPE_SUITE.planks, 5, 20);
		flammableRegistry.add(YMPE_SUITE.stairs, 5, 20);
		flammableRegistry.add(YMPE_SUITE.slab, 5, 20);
		flammableRegistry.add(YMPE_SUITE.fence, 5, 20);
		flammableRegistry.add(YMPE_SUITE.fenceGate, 5, 20);
