...
public class ModConfiguredFeatures {
    ...
    //public static final ConfiguredFeature<?, ?> SPRING = register("spring", SPRING_FEATURE, new SingleStateFeatureConfig(Blocks.WATER.getDefaultState()).range(Decorators.TOP_TO_BOTTOM).spreadHorizontally().applyChance(8));
