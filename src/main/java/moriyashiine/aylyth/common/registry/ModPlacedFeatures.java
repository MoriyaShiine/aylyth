...
public class ModPlacedFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> SHELF_JACK_O_LANTERN_MUSHROOMS = register("shelf_jack_o_lantern_mushrooms", ModConfiguredFeatures.SHELF_JACK_O_LANTERN_MUSHROOMS, List.of(SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of()));

    public static final RegistryEntry<PlacedFeature> GLOW_LICHEN = register("glow_lichen", ModConfiguredFeatures.GLOW_LICHEN, List.of(RarityFilterPlacementModifier.of(4), SquarePlacementModifier.of(), BiomePlacementModifier.of()));
