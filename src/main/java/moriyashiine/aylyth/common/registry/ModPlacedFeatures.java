...
public class ModPlacedFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> POMEGRANATE_TREE = register("pomegranate_tree", ModConfiguredFeatures.POMEGRANATE_TREE, List.of(CountPlacementModifier.of(1), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, PlacedFeatures.wouldSurvive(ModBlocks.YMPE_SAPLING)));
