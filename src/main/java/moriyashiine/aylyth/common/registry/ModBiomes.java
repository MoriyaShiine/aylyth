...
public class ModBiomes {
	...
	public static final RegistryEntry<Biome> CLEARING = BuiltinRegistries.addCasted(BuiltinRegistries.BIOME, CLEARING_ID.toString(), createClearing(false, new SpawnSettings.Builder()));
	public static final RegistryEntry<Biome> OVERGROWN_CLEARING = BuiltinRegistries.addCasted(BuiltinRegistries.BIOME, OVERGROWN_CLEARING_ID.toString(), createClearing(true, new SpawnSettings.Builder().spawn(SpawnGroup.AMBIENT, new SpawnSettings.SpawnEntry(ModEntityTypes.PILOT_LIGHT, 1, 1, 1)).creatureSpawnProbability(0.1F)));
	public static final RegistryEntry<Biome> FOREST = BuiltinRegistries.addCasted(BuiltinRegistries.BIOME, FOREST_ID.toString(), createForest(false, FOREST_MOBS));
	public static final RegistryEntry<Biome> DEEP_FOREST = BuiltinRegistries.addCasted(BuiltinRegistries.BIOME, DEEP_FOREST_ID.toString(), createForest(true, DEEP_FOREST_MOBS));
	public static final RegistryEntry<Biome> CONIFEROUS_FOREST = BuiltinRegistries.addCasted(BuiltinRegistries.BIOME, CONIFEROUS_FOREST_ID.toString(), createConiferousForest(false, FOREST_MOBS));
	public static final RegistryEntry<Biome> DEEP_CONIFEROUS_FOREST = BuiltinRegistries.addCasted(BuiltinRegistries.BIOME, DEEP_CONIFEROUS_FOREST_ID.toString(), createConiferousForest(true, DEEP_FOREST_MOBS));
