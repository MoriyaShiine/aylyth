...
public interface AylythFoods {
	...
	FoodComponent GHOSTCAPS = new FoodComponent.Builder().hunger(1).saturationModifier(0.75f)
			.statusEffect(new StatusEffectInstance(AylythEntityStatusEffects.CIMMERIAN, 1800, 0), 0.125f)
	...
	FoodComponent POMEGRANATE = new FoodComponent.Builder().hunger(4).saturationModifier(5)
			.statusEffect(new StatusEffectInstance(AylythEntityStatusEffects.CIMMERIAN, 1800, 0), 0.5f)
			.statusEffect(new StatusEffectInstance(AylythEntityStatusEffects.WYRDED, 6000, 0), 0.5f)
			.build();
