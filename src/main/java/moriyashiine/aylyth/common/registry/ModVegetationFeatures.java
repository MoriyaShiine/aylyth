...
public class ModVegetationFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<RandomFeatureConfig, ?>> CONIFEROUS_DEEPWOOD_TREES = registerConfigured("coniferous_deepwood_trees", Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(PlacedFeatures.createEntry(ModConfiguredFeatures.YMPE_TREE), 0.25F), new RandomFeatureEntry(PlacedFeatures.createEntry(ModConfiguredFeatures.BIG_YMPE_TREE), 0.25F)), TreePlacedFeatures.SPRUCE_CHECKED));
