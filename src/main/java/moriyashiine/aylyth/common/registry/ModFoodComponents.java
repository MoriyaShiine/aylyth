...
public class ModFoodComponents {
	...
	public static final FoodComponent WRONGMEAT = new FoodComponent.Builder().hunger(16).saturationModifier(16).statusEffect(new StatusEffectInstance(ModPotions.CIMMERIAN_EFFECT, 1800, 0), 0.5f).statusEffect(new StatusEffectInstance(ModPotions.WYRDED_EFFECT, 6000, 0), 0.5f).meat().build();
