...
public class BoneflyEntity extends HostileEntity implements GeoEntity, TameableHostileEntity, ProlongedDeath {
    ...
    public void travel(Vec3d travelVector) {
        ...
        if (passenger instanceof LivingEntity livingEntityPassenger) {
            ...
            boolean isPlayerUpwardsMoving = ModEntityComponents.RIDER_COMPONENT.get(livingEntityPassenger).isPressingUp();
            boolean isPlayerDownwardsMoving = ModEntityComponents.RIDER_COMPONENT.get(livingEntityPassenger).isPressingDown();
