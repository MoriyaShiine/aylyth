package moriyashiine.aylyth.common.entity.component;
...
public class VitalHealthComponent implements AutoSyncedComponent, VitalHealthHolder {
    ...
    public void setCurrentVitalHealth(float vital) {
        ...
        this.vitalLevel = (float) MathHelper.clamp(vital, 0, obj.getAttributeValue(AylythAttributes.MAX_VITAL_HEALTH));
        AylythEntityComponents.VITAL_HEALTH.sync(obj);
    }
}
