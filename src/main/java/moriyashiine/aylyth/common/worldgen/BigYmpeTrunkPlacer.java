...
public class BigYmpeTrunkPlacer extends GiantTrunkPlacer {
	public static final Codec<BigYmpeTrunkPlacer> CODEC = RecordCodecBuilder
			.create((instance) -> fillTrunkPlacerFields(instance).apply(instance, BigYmpeTrunkPlacer::new));
	...
	private void placeBranches(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random,
							   BlockPos startPos, TreeFeatureConfig config, List<FoliagePlacer.TreeNode> list,
							   int height, int xOffset, int zOffset, Direction... availableOffsets) {
