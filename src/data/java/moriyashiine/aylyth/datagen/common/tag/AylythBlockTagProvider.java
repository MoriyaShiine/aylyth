...
public final class AylythBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries) {
        ...
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE).addTag(AylythBlockTags.CARVED_NEPHRITE).add(ModBlocks.SOUL_HEARTH, ModBlocks.VITAL_THURIBLE, ModBlocks.ESSTLINE_BLOCK, ModBlocks.NEPHRITE_BLOCK);
        getOrCreateTagBuilder(BlockTags.NEEDS_IRON_TOOL).addTag(AylythBlockTags.CARVED_NEPHRITE).add(ModBlocks.NEPHRITE_BLOCK, ModBlocks.ESSTLINE_BLOCK);
        ...
        getOrCreateTagBuilder(AylythBlockTags.SEEPS).add(ModBlocks.OAK_SEEP, ModBlocks.SPRUCE_SEEP, ModBlocks.DARK_OAK_SEEP, ModBlocks.YMPE_SEEP, ModBlocks.SEEPING_WOOD_SEEP);
        getOrCreateTagBuilder(AylythBlockTags.WOODY_GROWTHS).add(ModBlocks.SMALL_WOODY_GROWTH, ModBlocks.LARGE_WOODY_GROWTH, ModBlocks.WOODY_GROWTH_CACHE);
        ...
        getOrCreateTagBuilder(AylythBlockTags.CHTHONIA_WOOD).add(ModBlocks.CHTHONIA_WOOD, ModBlocks.NEPHRITIC_CHTHONIA_WOOD);

        getOrCreateTagBuilder(AylythBlockTags.YMPE_LOGS).add(ModBlocks.YMPE_LOG, ModBlocks.YMPE_WOOD, ModBlocks.YMPE_STRIPPED_LOG, ModBlocks.YMPE_STRIPPED_WOOD, ModBlocks.FRUIT_BEARING_YMPE_LOG);
        ...
        getOrCreateTagBuilder(AylythBlockTags.POMEGRANATE_LOGS).add(ModBlocks.POMEGRANATE_LOG, ModBlocks.POMEGRANATE_WOOD, ModBlocks.POMEGRANATE_STRIPPED_LOG, ModBlocks.POMEGRANATE_STRIPPED_WOOD);
        ...
        getOrCreateTagBuilder(AylythBlockTags.WRITHEWOOD_LOGS).add(ModBlocks.WRITHEWOOD_LOG, ModBlocks.WRITHEWOOD_WOOD, ModBlocks.WRITHEWOOD_STRIPPED_LOG, ModBlocks.WRITHEWOOD_STRIPPED_WOOD);
