...
public final class AylythConfiguredFeatureBootstrap {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        ConfiguredFeatures.register(context, ORANGE_AYLYTHIAN_DARK_OAK, Feature.TREE, createAylythianOakTree(AylythBlocks.ORANGE_AYLYTHIAN_OAK_LEAVES, oakStrewnLeavesConfigured, oakLeafPileConfigured, AylythBlocks.ORANGE_AYLYTHIAN_OAK_BRANCH));
        ConfiguredFeatures.register(context, ORANGE_AYLYTHIAN_DARK_OAK_PODZOL, Feature.TREE, createAylythianOakTreeBuilder(AylythBlocks.ORANGE_AYLYTHIAN_OAK_LEAVES, oakStrewnLeavesConfigured, oakLeafPileConfigured, AylythBlocks.ORANGE_AYLYTHIAN_OAK_BRANCH).dirtProvider(BlockStateProvider.of(AylythBlocks.DARK_PODZOL)).build());
        ...
        ConfiguredFeatures.register(context, RED_AYLYTHIAN_DARK_OAK, Feature.TREE, createAylythianOakTree(AylythBlocks.RED_AYLYTHIAN_OAK_LEAVES, oakStrewnLeavesConfigured, oakLeafPileConfigured, AylythBlocks.RED_AYLYTHIAN_OAK_BRANCH));
        ConfiguredFeatures.register(context, RED_AYLYTHIAN_DARK_OAK_PODZOL, Feature.TREE, createAylythianOakTreeBuilder(AylythBlocks.RED_AYLYTHIAN_OAK_LEAVES, oakStrewnLeavesConfigured, oakLeafPileConfigured, AylythBlocks.RED_AYLYTHIAN_OAK_BRANCH).dirtProvider(BlockStateProvider.of(AylythBlocks.DARK_PODZOL)).build());
        ...
        ConfiguredFeatures.register(context, BROWN_AYLYTHIAN_DARK_OAK, Feature.TREE, createAylythianOakTree(AylythBlocks.BROWN_AYLYTHIAN_OAK_LEAVES, oakStrewnLeavesConfigured, oakLeafPileConfigured, AylythBlocks.BROWN_AYLYTHIAN_OAK_BRANCH));
