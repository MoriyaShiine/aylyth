...
public class AylythLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder builder) {
        ...
        builder.add(ModBlocks.CHTHONIA_WOOD, "Chthonia Wood");
        builder.add(ModBlocks.NEPHRITIC_CHTHONIA_WOOD, "Nephritic Chthonia Wood");
        ...
        builder.add(ModItems.LANCEOLATE_DAGGER, "Lanceolate Dagger");
