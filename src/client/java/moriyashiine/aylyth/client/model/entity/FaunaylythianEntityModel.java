...
public class FaunaylythianEntityModel extends GeoModel<FaunaylythianEntity> {
    ...
    @Override
    public Identifier getModelResource(FaunaylythianEntity animatable, @Nullable GeoRenderer<FaunaylythianEntity> renderer) {
        return MODEL_LOCATION;
    }

    @Override
    public Identifier getTextureResource(FaunaylythianEntity animatable, @Nullable GeoRenderer<FaunaylythianEntity> renderer) {
