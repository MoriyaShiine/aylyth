...
/*
		...
		ModelPartData cube_r1 = body.addChild("cube_r1", ModelPartBuilder.create().uv(0, 4).cuboid(0.0F, 0.0F, -1.5F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(1.5F, 4.5F, 2.5F, -2.2689F, -0.7418F, 0.4363F));

		ModelPartData cube_r2 = body.addChild("cube_r2", ModelPartBuilder.create().uv(0, 4).cuboid(0.0F, 0.0F, -1.5F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.5F, 7.5F, 2.5F, -2.0071F, -0.6109F, 2.2689F));

		ModelPartData cube_r3 = body.addChild("cube_r3", ModelPartBuilder.create().uv(0, 4).cuboid(0.0F, 0.0F, -1.5F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-2.5F, 5.5F, 2.5F, -0.7854F, -2.0944F, 0.0F));

		ModelPartData cube_r4 = body.addChild("cube_r4", ModelPartBuilder.create().uv(0, 4).cuboid(0.0F, 0.0F, -1.5F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.5F, 7.5F, -2.5F, -1.4835F, 0.5236F, -1.9199F));

		ModelPartData cube_r5 = body.addChild("cube_r5", ModelPartBuilder.create().uv(0, 0).cuboid(0.0F, 0.0F, -2.0F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.5F, 3.5F, -2.5F, -1.5708F, 0.5672F, -2.9671F));

		ModelPartData cube_r6 = body.addChild("cube_r6", ModelPartBuilder.create().uv(0, 0).cuboid(0.0F, 0.0F, -2.0F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(2.5F, 5.5F, -2.5F, -1.4835F, 0.5236F, 1.0472F));

		ModelPartData cube_r7 = body.addChild("cube_r7", ModelPartBuilder.create().uv(0, 0).cuboid(0.0F, 0.0F, -2.0F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(3.5F, 2.5F, -2.5F, -1.4835F, 0.5236F, 0.0F));

		ModelPartData cube_r8 = body.addChild("cube_r8", ModelPartBuilder.create().uv(0, 4).cuboid(0.0F, 0.0F, -1.5F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.5F, 4.5F, -2.5F, -1.4835F, 0.5236F, -0.9599F));

		ModelPartData bodyOverlay = body.addChild("bodyOverlay", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData crown = head.addChild("crown", ModelPartBuilder.create().uv(84, 98).cuboid(-3.5F, -7.0F, -1.0F, 7.0F, 7.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -31.4F, -4.5F, -0.8727F, 0.0F, 0.0F));

		ModelPartData lFaceWood = head.addChild("lFaceWood", ModelPartBuilder.create(), ModelTransform.of(4.0F, -29.25F, -1.0F, 0.0F, 0.1309F, 0.0F));

		ModelPartData cube_r9 = lFaceWood.addChild("cube_r9", ModelPartBuilder.create().uv(72, 105).cuboid(-1.5F, -3.0F, -1.0F, 2.0F, 5.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.1309F, 0.2182F, 0.0F));

		ModelPartData rFaceWood = head.addChild("rFaceWood", ModelPartBuilder.create(), ModelTransform.of(-4.0F, -29.25F, -1.0F, 0.0F, -0.1309F, 0.0F));

		ModelPartData cube_r10 = rFaceWood.addChild("cube_r10", ModelPartBuilder.create().uv(72, 105).mirrored().cuboid(-0.5F, -3.0F, -1.0F, 2.0F, 5.0F, 6.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.1309F, -0.2182F, 0.0F));

		ModelPartData lUpperAntler01 = head.addChild("lUpperAntler01", ModelPartBuilder.create().uv(102, 4).mirrored().cuboid(-1.0F, -1.0F, -1.8F, 2.0F, 2.0F, 3.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(3.4F, -32.6F, -1.0F, 0.6458F, 0.1396F, 0.6109F));
		...
		ModelPartData rUpperAntler01 = head.addChild("rUpperAntler01", ModelPartBuilder.create().uv(102, 4).cuboid(-1.0F, -1.0F, -1.8F, 2.0F, 2.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-3.4F, -32.6F, -1.0F, 0.6458F, -0.1396F, -0.6109F));
		...
		ModelPartData headOverlay = head.addChild("headOverlay", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData lArmOverlay = leftArm.addChild("lArmOverlay", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData rightArm = ModelPartData.addChild(EntityModelPartNames.RIGHT_ARM, ModelPartBuilder.create().uv(108, 79).cuboid(-4.5F, -2.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData rArmOverlay = rightArm.addChild("rArmOverlay", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData leftLeg = ModelPartData.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create().uv(92, 6).cuboid(1.0F, 5.5F, -1.0F, 2.0F, 7.0F, 3.0F, new Dilation(0.0F))
				.uv(92, 8).cuboid(-1.0F, 7.5F, 2.0F, 4.0F, 5.0F, 1.0F, new Dilation(0.0F))
				.uv(92, 11).cuboid(-1.0F, 9.5F, -3.0F, 4.0F, 3.0F, 2.0F, new Dilation(0.0F))
				.uv(108, 58).cuboid(-2.2F, -0.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(4.0F, 0.0F, 0.0F));
		...
		ModelPartData lLegOverlay = leftLeg.addChild("lLegOverlay", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData rightLeg = ModelPartData.addChild(EntityModelPartNames.RIGHT_LEG, ModelPartBuilder.create().uv(87, 5).cuboid(-7.0F, 5.5F, -1.0F, 4.0F, 7.0F, 4.0F, new Dilation(0.0F))
				.uv(104, 3).cuboid(-7.0F, 10.5F, -3.0F, 5.0F, 2.0F, 2.0F, new Dilation(0.0F))
				.uv(96, 10).cuboid(-7.0F, 7.5F, -3.0F, 3.0F, 3.0F, 2.0F, new Dilation(0.0F))
				.uv(84, 57).cuboid(-6.75F, -0.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r24 = rightLeg.addChild("cube_r24", ModelPartBuilder.create().uv(0, 4).cuboid(-0.25F, 0.0F, -1.75F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.75F, 3.5F, 2.5F, -0.9599F, -2.9234F, 1.4835F));

		ModelPartData cube_r25 = rightLeg.addChild("cube_r25", ModelPartBuilder.create().uv(0, 4).cuboid(-0.25F, 0.0F, -1.75F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-4.75F, 4.5F, 2.5F, -0.9599F, -2.9234F, 1.1781F));

		ModelPartData cube_r26 = rightLeg.addChild("cube_r26", ModelPartBuilder.create().uv(0, 4).cuboid(-0.5F, 0.0F, -1.75F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-6.75F, 2.5F, -1.5F, 2.3562F, -0.1222F, 2.7489F));

		ModelPartData cube_r27 = rightLeg.addChild("cube_r27", ModelPartBuilder.create().uv(0, 4).cuboid(-0.5F, 0.0F, -1.75F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-6.75F, 4.5F, 0.5F, 2.3562F, -0.9076F, 2.138F));
		...
		ModelPartData cube_r30 = rightLeg.addChild("cube_r30", ModelPartBuilder.create().uv(0, 4).cuboid(0.0F, 0.0F, -2.0F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-3.5F, 5.0F, -2.5F, -1.0908F, 0.4363F, -1.0036F));

		ModelPartData rLegOverlay = rightLeg.addChild("rLegOverlay", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
*/
		ModelPartData head = ModelPartData.addChild(EntityModelPartNames.HEAD, ModelPartBuilder.create()
						.uv(80, 110).cuboid(-4.5F, -8.5F, -4.5F, 9.0F, 9.0F, 9.0F, new Dilation(0.0F))
						.uv(0, 0).cuboid(-4F, -8.5F, -4.5F, 8.0F, 8.0F, 8.0F, new Dilation(0.3F)),
				ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		//ModelPartData overlay_head = head.addChild("overlay_head", ModelPartBuilder.create().uv(0, 0).cuboid(-4.5F, -8.5F, -4.5F, 9.0F, 9.0F, 9.0F, new Dilation(0.3F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData body = ModelPartData.addChild(EntityModelPartNames.BODY, ModelPartBuilder.create()
						.uv(78, 79).cuboid(-4.5F, -0.5F, -2.5F, 9.0F, 13.0F, 5.0F, new Dilation(0.1F))
						.uv(16, 16).cuboid(-4.5F, -0.5F, -2F, 8.0F, 12.0F, 4.0F, new Dilation(0.3F)),
				ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		//ModelPartData overlay_body = body.addChild("overlay_body", ModelPartBuilder.create().uv(16, 16).cuboid(-4.5F, -0.5F, -2.5F, 9.0F, 13.0F, 5.0F, new Dilation(0.3F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leftArm = ModelPartData.addChild(EntityModelPartNames.LEFT_ARM, ModelPartBuilder.create()
						.uv(108, 99).cuboid(-1.5F, -2.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.0F))
						.uv(32, 48).cuboid(-1.75F, -2.5F, -2.25F, 4.0F, 12.0F, 4.0F, new Dilation(0.3F)),
				ModelTransform.pivot(4.0F, 2.0F, 0.0F));
		//ModelPartData overlay_leftArm = leftArm.addChild("overlay_leftArm", ModelPartBuilder.create().uv(32, 48).cuboid(-3.5F, -2.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.3F)), ModelTransform.pivot(4.0F, 2.0F, 0.0F));
		...
		ModelPartData rightArm = ModelPartData.addChild(EntityModelPartNames.RIGHT_ARM, ModelPartBuilder.create()
				.uv(108, 79).cuboid(-3.5F, -2.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.0F))
				.uv(40, 16).cuboid(-3.5F, -2.5F, -2.25F, 4.0F, 12.0F, 4.0F, new Dilation(0.3F)),
				ModelTransform.pivot(-4.0F, 2.0F, 0.0F));

		//ModelPartData overlay_rightArm = rightArm.addChild("overlay_rightArm", ModelPartBuilder.create().uv(40, 16).cuboid(0F, -2.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.3F)), ModelTransform.pivot(-4.0F, 2.0F, 0.0F));
		...
		ModelPartData leftLeg = ModelPartData.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create()
						.uv(92, 6).cuboid(1.0F, 5.5F, -1.0F, 2.0F, 7.0F, 3.0F, new Dilation(0.0F))
						.uv(92, 8).cuboid(-1.0F, 7.5F, 2.0F, 4.0F, 5.0F, 1.0F, new Dilation(0.0F))
						.uv(92, 11).cuboid(-1.0F, 9.5F, -3.0F, 4.0F, 3.0F, 2.0F, new Dilation(0.0F))
						.uv(108, 58).cuboid(-2.2F, -0.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.0F))
						.uv(16, 48).cuboid(-2.45F, -0.5F, -2.5F, 4.0F, 12.0F, 4.0F, new Dilation(0.3F)),
				ModelTransform.pivot(2.0F, 12.0F, 0.0F));
		//ModelPartData overlay_leftLeg = leftLeg.addChild("overlay_leftLeg", ModelPartBuilder.create().uv(16, 48).cuboid(1.0F, 5.5F, -1.0F, 2.0F, 7.0F, 3.0F, new Dilation(0.3F)).uv(92, 8).cuboid(-1.0F, 7.5F, 2.0F, 4.0F, 5.0F, 1.0F, new Dilation(0.0F)).uv(92, 11).cuboid(-1.0F, 9.5F, -3.0F, 4.0F, 3.0F, 2.0F, new Dilation(0.0F)).uv(108, 58).cuboid(-2.2F, -0.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(2.0F, 12.0F, 0.0F));

		ModelPartData cube_r22 = leftLeg.addChild("cube_r22", ModelPartBuilder.create().uv(0, 4).cuboid(-0.25F, 0.0F, -1.5F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-0.25F, 4.5F, -2.5F, -1.2248F, 0.2848F, -0.8469F));
		ModelPartData cube_r23 = leftLeg.addChild("cube_r23", ModelPartBuilder.create().uv(0, 4).cuboid(-0.25F, 0.0F, -1.5F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(2.75F, 2.5F, -1.5F, -0.9163F, -1.0036F, -0.1745F));

		ModelPartData rightLeg = ModelPartData.addChild(EntityModelPartNames.RIGHT_LEG, ModelPartBuilder.create()
						.uv(87, 5).cuboid(-3.0F, 5.5F, -1.0F, 4.0F, 7.0F, 4.0F, new Dilation(0.0F))
						.uv(104, 3).cuboid(-3.0F, 10.5F, -3.0F, 5.0F, 2.0F, 2.0F, new Dilation(0.0F))
						.uv(96, 10).cuboid(-3.0F, 7.5F, -3.0F, 3.0F, 3.0F, 2.0F, new Dilation(0.0F))
						.uv(84, 57).cuboid(-2.75F, -0.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.0F))
						.uv(0, 16).cuboid(-2.5F, -0.5F, -2.5F, 4.0F, 12.0F, 4.0F, new Dilation(0.3F)),
				ModelTransform.pivot(-2.0F, 12.0F, 0.0F));

		//ModelPartData overlay_rightLeg = rightLeg.addChild("overlay_rightLeg", ModelPartBuilder.create().uv(0, 16).cuboid(-3.0F, 5.5F, -1.0F, 4.0F, 7.0F, 4.0F, new Dilation(0.3F)).uv(104, 3).cuboid(-3.0F, 10.5F, -3.0F, 5.0F, 2.0F, 2.0F, new Dilation(0.0F)).uv(96, 10).cuboid(-3.0F, 7.5F, -3.0F, 3.0F, 3.0F, 2.0F, new Dilation(0.0F)).uv(84, 57).cuboid(-2.75F, -0.5F, -2.5F, 5.0F, 13.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(-2.0F, 12.0F, 0.0F));
