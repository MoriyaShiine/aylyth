...
public class VitalThuribleBlockEntityRenderer implements BlockEntityRenderer<VitalThuribleBlockEntity> {
    private static final List<Vector4fc> POS = Util.make(new ObjectArrayList<>(), list -> {
        list.add(new Vector4f(-0.1F, 0.03F, -0.1F, 25 * MathHelper.RADIANS_PER_DEGREE));
        list.add(new Vector4f(0.1F, 0.06F, -0.1F, -45 * MathHelper.RADIANS_PER_DEGREE));
        list.add(new Vector4f(0.1F, 0.01F, 0.1F, 15 * MathHelper.RADIANS_PER_DEGREE));
        list.add(new Vector4f(-0.1F, 0.07F, 0.1F, 65 * MathHelper.RADIANS_PER_DEGREE));
        list.add(new Vector4f(0.05F, 0.1F, 0.05F, -35 * MathHelper.RADIANS_PER_DEGREE));
    });
